...
const { verifyToken, optionalAuth, optionalAuthOrApiKey, verifyTokenOrApiKey } = require('../middleware/auth');
...
router.post('/chat', optionalAuthOrApiKey, async (req, res) => {
  try {
...
router.get('/limit', verifyTokenOrApiKey, (req, res) => {
