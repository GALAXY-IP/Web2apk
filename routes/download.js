...
const { optionalAuth, optionalAuthOrApiKey } = require('../middleware/auth');
...
// Get video info
router.post('/info', optionalAuthOrApiKey, async (req, res) => {
  try {
    const { url } = req.body;
...
// Download video
router.post('/video', optionalAuthOrApiKey, async (req, res) => {
