...
router.post('/', verifyTokenOrApiKey, requireProMax, upload.fields([
...
router.get('/my', verifyTokenOrApiKey, requireProMax, (req, res) => {
...
router.delete('/delete', verifyTokenOrApiKey, requireProMax, (req, res) => {
